...
## Project Structure
- `frontend/`: React + Vite based 3D visualization dashboard.
- `backend/`: Node.js + WebSocket server for real-time simulation logic.
- `ai-service/`: Python + FastAPI scaffold for future AI-driven trajectory predictions.
- `docs/`: Additional documentation and project assets.
...
---
Developed as a proof-of-concept for intelligent traffic systems.
